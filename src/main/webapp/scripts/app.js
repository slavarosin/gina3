...
var gina3App = angular.module('gina3App', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'gina3AppUtils', 'pascalprecht.translate', 'truncate']);
